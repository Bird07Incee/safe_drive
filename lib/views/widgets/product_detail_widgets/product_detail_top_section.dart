...
import 'package:marketplace_line_oa/views/widgets/product_detail_widgets/car_gallery_indicator_widget.dart';
import 'package:marketplace_line_oa/views/widgets/product_detail_widgets/product_gallery_list_widget.dart';
import 'package:marketplace_line_oa/constants/mkp_styles.dart';

typedef OnTap = Function();

class CarDetailTopSection extends StatelessWidget {
  const CarDetailTopSection({Key? key, required this.onTap}) : super(key: key);
  final OnTap onTap;
      ...
      builder: (context) {
        return Column(
          children: [
            ...
            //     children: [
            //       // Dot Indicator
            //       CarGalleryIndicatorWidget(pageViewController: pageViewController),
            //       // Car Post Title
            //       Container(
