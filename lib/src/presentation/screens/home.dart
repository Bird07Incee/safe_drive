                          ...
                          return Container(
                              ...
                              child: ListView(
                                ...
                                children: [
                                  ...
                                  StickyHeader(
                                    header: Visibility(
                                      visible: (state.productList.category != null) &&
                                              (state.productList.products.length == 1 || state.productList.category!.isEmpty)
                                          ? true
                                          : false,
                                      child: Container(
                                        width: maxWidth,
                                          ...
                                          child: GestureDetector(
                                            ...
                                            onTap: () {
                                              if (tab == 0) {
                                                ...
                                                context.read<ProductListBloc>().add(GetProductListByPage(state.productList,
                                                    state.productList.productPage! + 1, state.productList.category![tab - 1]["categoryId"], context));
                                              }
                                            },
                                            child: Column(
                                              children: [
