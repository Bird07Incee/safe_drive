                  ...
                  builder: (context, state) {
                    return BlocConsumer<AuthBloc, AuthState>(listener: (context, stateAuth) {
                      ...
                      if (state.productListStatus == GetProductListStatus.maintenance) {
                        ...
                        return Container(
                            color: cloudyWhite,
                            child: BlocBuilder<HomeScrollControllerCubit, HomeScrollControllerCubitState>(builder: (context, scrollState) {
                              scrollController ??= ScrollController(initialScrollOffset: scrollState.scrollControllerPosition);
                              return ListView(
