                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              SizedBox(
                                                ...
                                                height: 24,
                                                child: Radio(
                                                  value: widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!].level2[index].label,
                                          ...
                                          Expanded(
                                            child: AlvaTextMaxLinesOverflow(
                                                title: widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!].level2[index].label,
                                                maxLines: 1,
                                                textStyle: AlvaStyles().bodySize14W600(BTN_SELECTED_TEXT_COLOR_NEW)),
                                          ),
                                          SizedBox(width: 16),
                                          AlvaText(
                                            title: "${widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!].level2[index].price.toDecimalFormat()} บาท",
                                            textStyle: AlvaStyles().headingSize12w400(spaceGrey),
                                          ),
                                        ],
                                      ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  prodOptState.stepTwoGroupValueRadio == ""
                                      ? AlvaText(
                                    title: "ตัวเลือก${widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!].level2[0].levelName}",
                                    textStyle: AlvaStyles().bodySize14W600(cloudSoftDeepWhite),
                                  )
                                      : Expanded(
                                    child: AlvaTextMaxLinesOverflow(
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(width: 16),
                                          AlvaText(
                                            title: "${widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!].level2[prodOptState.stepTwoIndexSelect!].level3[index].price.toDecimalFormat()} บาท",
                                            textStyle: AlvaStyles().headingSize12w400(spaceGrey),
                                          ),
                                        ],
                                      ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  prodOptState.stepTreeGroupValueRadio == ""
                                      ? AlvaText(
                                    title: "ตัวเลือก${widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!].level2[prodOptState.stepTwoIndexSelect!].level3[0].levelName}",
                                    textStyle: AlvaStyles().bodySize14W600(cloudSoftDeepWhite),
                                  )
                                      :Expanded(
                                    child: AlvaTextMaxLinesOverflow(
                  ...
                  prodOptState.stepTreeGroupValueRadio == "" ||
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: AlvaText(
                          title: widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!]
                              .level2[prodOptState.stepTwoIndexSelect!].level3[prodOptState.stepTreeIndexSelect!]
                              .level4[0].levelName,
                          textStyle: AlvaStyles().headingSize14w700(BTN_SELECTED_TEXT_COLOR_NEW),
                        ),
                      ),
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              SizedBox(
                                                ...
                                                child: Radio(
                                                  value: widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!]
                                                      .level2[prodOptState.stepTwoIndexSelect!].level3[prodOptState.stepTreeIndexSelect!].level4[index].label,
                                              ...
                                              Visibility(
                                                visible:
                                                widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!]
                                                    .level2[prodOptState.stepTwoIndexSelect!].level3[prodOptState.stepTreeIndexSelect!].level4[index].image == ""
                                                    ? false
                                                    : true,
                                                child: Row(
                                                  children: [
                                          ...
                                          SizedBox(width: 16),
                                          AlvaText(
                                            title: "${widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!].level2[prodOptState.stepTwoIndexSelect!].level3[prodOptState.stepTreeIndexSelect!].level4[index].price.toDecimalFormat()} บาท",
                                            textStyle: AlvaStyles().headingSize12w400(spaceGrey),
                                          ),
                                        ],
                                      ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  prodOptState.stepFourGroupValueRadio == ""
                                      ? AlvaText(
                                    title: "ตัวเลือก${widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!].level2[prodOptState.stepTwoIndexSelect!].level3[prodOptState.stepTreeIndexSelect!].level4[0].levelName}",
                                    textStyle: AlvaStyles().bodySize14W600(cloudSoftDeepWhite),
                                  )
                                      :  Expanded(
                                    child: AlvaTextMaxLinesOverflow(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: AlvaText(
                          title: widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!]
                              .level2[prodOptState.stepTwoIndexSelect!].level3[prodOptState.stepTreeIndexSelect!]
                              .level4[prodOptState.stepFourIndexSelect!].level5[0].levelName,
                          textStyle: AlvaStyles().headingSize14w700(BTN_SELECTED_TEXT_COLOR_NEW),
                        ),
                      ),
                      // Second Container
                        ...
                        child: Column(
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemCount: widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!]
                                  .level2[prodOptState.stepTwoIndexSelect!].level3[prodOptState.stepTreeIndexSelect!]
                                  .level4[prodOptState.stepFourIndexSelect!].level5.length,
                              itemBuilder: (BuildContext context, int index) {
                                return Column(
                                  children: [
                                    // Nested Container inside ListView.builder
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                            ...
                                            children: [
                                              SizedBox(
                                                ...
                                                child: Radio(
                                                  value: widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!]
                                                      .level2[prodOptState.stepTwoIndexSelect!].level3[prodOptState.stepTreeIndexSelect!]
                                                      .level4[prodOptState.stepFourIndexSelect!].level5[index].label,
                                              ...
                                              Visibility(
                                                ...
                                                widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!]
                                                    .level2[prodOptState.stepTwoIndexSelect!].level3[prodOptState.stepTreeIndexSelect!]
                                                    .level4[prodOptState.stepFourIndexSelect!].level5[index].image == ""
                                                    ? false
                                                    : true,
                                                child: Row(
                                                  children: [
                                          ...
                                          SizedBox(width: 16),
                                          AlvaText(
                                            title: "${widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!].level2[prodOptState.stepTwoIndexSelect!].level3[prodOptState.stepTreeIndexSelect!].level4[prodOptState.stepFourIndexSelect!].level5[index].price.toDecimalFormat()} บาท",
                                            textStyle: AlvaStyles().headingSize12w400(spaceGrey),
                                          ),
                                        ],
                                      ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  prodOptState.stepFiveGroupValueRadio == ""
                                      ? AlvaText(
                                    title: "ตัวเลือก${widget.arguments!.product.productionOptionals[prodOptState.stepOneIndexSelect!].level2[prodOptState.stepTwoIndexSelect!].level3[prodOptState.stepTreeIndexSelect!].level4[prodOptState.stepFourIndexSelect!].level5[0].levelName}",
                                    textStyle: AlvaStyles().bodySize14W600(cloudSoftDeepWhite),
                                  )
                                      :   Expanded(
                                    child: AlvaTextMaxLinesOverflow(
