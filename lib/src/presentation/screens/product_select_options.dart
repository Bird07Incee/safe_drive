            ...
            children: [
              Expanded(
                child: Container(
                  ...
                  height: 48,
                  child: prodOptState.selectCurrentOption==prodOptState.lastOption  ? OutlinedButton(
                    onPressed: () {
                    },
                    style: AlvaStyles().outlineNoneBorderButtonStyle(YellowKrungsri, Colors.transparent),
                    child: AlvaText(
                        title: "ดำเนินการต่อ", textStyle: AlvaStyles().headingSize16w700(BTN_SELECTED_TEXT_COLOR_NEW)),
                  )
                      : OutlinedButton(
                    onPressed: () {},
                    style: AlvaStyles().outlineNoneBorderButtonStyle(cloudSoftDeepWhite, Colors.transparent),
                    child: AlvaText(
                        title: "ดำเนินการต่อ", textStyle: AlvaStyles().headingSize16w700(smockGrey)),
                  ) ,
                ),
              )
            ],
              ...
              if (state.productListStatus == GetProductListStatus.success) {
                return ListView(
                  children: [
                                              ...
                                              Row(
                                                children: [
                                                  SizedBox(
                                                    ...
                                                    child: Radio(
                                                      value: state
                                                          .productList.products![0].productionOptionals[index].label,
                                                      ...
                                                      onChanged: (value) {
                                                        if (value == null) {
                                                          ...
                                                          if(state.productList.products![0].productionOptionals[index].level2.isNotEmpty){
                    ...
                    prodOptState.stepOneGroupValueRadio == "" ||
                        state.productList.products![0].productionOptionals[prodOptState.stepOneIndexSelect!].level2.isEmpty
                        ? Container()
                        : Column(
                      children: [
                        Container(
                          ...
                          padding: EdgeInsets.fromLTRB(0, 8, 0, 8),
                          child: AlvaText(
                            title: state.productList.products![0].productionOptionals[prodOptState.stepOneIndexSelect!]
                                .level2[0].levelName,
                            textStyle: AlvaStyles().headingSize14w700(BTN_SELECTED_TEXT_COLOR_NEW),
                          ),
                        ),
                                                      ...
                                                      onChanged: (value) {
                                                        if (value == null) {
                                                          ...
                                                          if(state
                                                              ...
                                                              .products![0]
                                                              .productionOptionals[myBloc.state.stepOneIndexSelect!]
                                                              .level2[index].level3.isNotEmpty){
                                                      ...
                                                      onChanged: (value) {
                                                        if (value == null) {
                                                          ...
                                                          if(state
                                                              ...
                                                              .productionOptionals[myBloc.state.stepOneIndexSelect!]
                                                              .level2[myBloc.state.stepTwoIndexSelect!]
                                                              .level3[index].level4.isNotEmpty){
                    ...
                    prodOptState.stepTreeGroupValueRadio == "" ||
                        state.productList.products![0].productionOptionals[prodOptState.stepOneIndexSelect!]
                            .level2[prodOptState.stepTwoIndexSelect!].level3[prodOptState.stepTreeIndexSelect!].level4.isEmpty
                        ? Container()
                        : Column(
                      children: [
                        Container(
                          ...
                          child: AlvaText(
                            title: state.productList.products![0].productionOptionals[prodOptState.stepOneIndexSelect!]
                                .level2[prodOptState.stepTwoIndexSelect!].level3[prodOptState.stepTreeIndexSelect!].level4[0].levelName,
                            textStyle: AlvaStyles().headingSize14w700(BTN_SELECTED_TEXT_COLOR_NEW),
                          ),
                        ),
                        Container(
                                                      ...
                                                      onChanged: (value) {
                                                        if (value == null) {
                                                          ...
                                                          if(state
                                                              ...
                                                              .level2[prodOptState.stepTwoIndexSelect!]
                                                              .level3[prodOptState.stepTreeIndexSelect!]
                                                              .level4[index].level5.isNotEmpty){
