                                                            ...
                                                            ? ClipRRect(
                                                                ...
                                                                child: FadeInImage(
                                                                  ...
                                                                  image: NetworkImage(step1.isNotEmpty &&
                                                                          state.product.productionOptionals[pdOptState.stepOneIndexSelect ?? 0].image
                                                                              .isNotEmpty
                                                                      ? state.product.productionOptionals[pdOptState.stepOneIndexSelect ?? 0].image
                                                          ...
                                                          : Padding(
                                                              ...
                                                              child: SizedBox(
                                                                ...
                                                                child: AlvaTextMaxLinesOverflow(
                                                                    maxLines: 5,
                                                                    title:
                                                                        "${state.product.productionOptionals[pdOptState.stepOneIndexSelect ?? 0].levelName}: $step1",
                                                                    textStyle: AlvaStyles()
                                                      ...
                                                      step1.isNotEmpty
                                                          ? Padding(
                                                              ...
                                                              child: SizedBox(
                                                                ...
                                                                child: AlvaTextMaxLinesOverflow(
                                                                    title:
                                                                        "${state.product.productionOptionals[pdOptState.stepOneIndexSelect ?? 0].levelName}: ${state.product.productionOptionals[pdOptState.stepOneIndexSelect ?? 0].label}",
                                                                    maxLines: 5,
                                                                    textStyle: AlvaStyles()
                                                                        .headingSize10w400(BTN_SELECTED_TEXT_COLOR_NEW)
                                                                        .copyWith(height: 1.6)),
                                                      ...
                                                      GeneralDialog(
                                                              onAccept: () async {
                                                                ...
                                                                ProductionOptionals step1SelectedOption = state.product.productionOptionals.isEmpty
                                                                    ...
                                                                    : state.product.productionOptionals[pdOptState.stepOneIndexSelect ?? 0];
                                                                ...
                                                                requestModel = CreateOrderRequestModel(
                                                                  ...
                                                                  products: [
                                                                    OrderProduct(
                                                                        ...
                                                                        qty: 1,
                                                                        unitPrice:
                                                                            state.product.productionOptionals.isNotEmpty ? step1price : showPrice,
