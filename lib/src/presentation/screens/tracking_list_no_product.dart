              ...
              child: Column(
                ...
                children: [
                  SizedBox(width: 64, height: 68,
                      child: Image.asset(
                          'assets/images/category/icon_box_no_status.png')),
                  const SizedBox(
                    height: 16,
                  ),
              ...
              child: GestureDetector(
                ...
                onTap: () {
                  Navigator.pushNamedAndRemoveUntil(
                      context, Routes.initial.toStringPath(), (
                      route) => false);
                },
                child: Container(
                  height: 48,
                  width: (maxWidth - 40) / 2,
                  decoration: BoxDecoration(color: const Color(0xffffd400),
                      borderRadius: const BorderRadius.all(
                          Radius.circular(8))),
                  child: Center(child: Text(
                      "กลับสู่หน้าหลัก", style: AlvaStyles().heading3())),
                ),
              ))
        ],
      ),
