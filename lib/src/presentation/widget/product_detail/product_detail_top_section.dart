  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ProductDetailBloc, ProductDetailState>(
      builder: (context, state) {
        ...
        var zoomArguments = context.read<ImgGalleryZoomBloc>().state;
        var carouselArguments = context.read<ProductDetailCarouselScrollControllerBloc>().state;
        var descriptionState = context.read<ProductDetailDescriptionCubit>().state;
        return Container(
                            ...
                            child: Container(
                              ...
                              child: HtmlWidget(
                                  tagline.contains("<table")
                                      ? tagline
                                      : descriptionState.toggleDescription || (lineFinal <= maxLines && truncatedHtmlText.containsHtmlTags(tagline))
                                          ...
                                          Expanded(
                                            child: Container(
                                              ...
                                              child: OutlinedButton(
                                                ...
                                                child: AlvaText(
                                                  title:
                                                      descriptionState.toggleDescription ? AppStrings().btnHideDescription : AppStrings().btnReadMore,
