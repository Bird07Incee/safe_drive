...
class PDTopSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: BlocBuilder<ProductDetailCarouselScrollControllerBloc, PageController>(builder: (context, carouselState) {
        return Column(
          children: [
            Stack(
              children: [
                AspectRatio(
                  ...
                  child: PageView.builder(
                      itemCount:
                          args.product.productionAssets.length == 1 ? 1 : args.product.productionAssets.length + 1,
