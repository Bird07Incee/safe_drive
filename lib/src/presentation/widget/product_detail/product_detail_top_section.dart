                  ...
                  children: [
                      ...
                      children: [
                        AspectRatio(
                          ...
                          child: PageView.builder(
                              itemCount: state.selectedProduct.productionAssets.length == 1 ? 1 : state.selectedProduct.productionAssets.length + 1,
                              controller: carouselState,
                              onPageChanged: (val) {
                                context
                                    .read<ProductDetailCarouselScrollControllerBloc>()
                                    .add(CarouselScrollAction(index: val));
                                if (val == state.selectedProduct.productionAssets.length && val != 1) {
                                  ...
                                  child: AspectRatio(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: FadeInImage(
                                        ...
                                        image: NetworkImage(
                                          i == state.selectedProduct.productionAssets.length ? state.selectedProduct.productionAssets[0] : state.selectedProduct.productionAssets[i],
                                        ),
                                        fit: BoxFit.fitWidth,
                        ...
                        Positioned.fill(
                            child: Align(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: AlvaText(
                                      title: "${carouselState.initialPage + 1}/${state.selectedProduct.productionAssets.length}",
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Visibility(
                            visible: state.selectedProduct.productionAssets.length == 1 ? false : true,
                            child: Padding(
                              padding: const EdgeInsets.fromLTRB(0, 0, 0, 8),
                              child: SmoothPageIndicator(
                                  controller: carouselState,
                                  count: state.selectedProduct.productionAssets.length <= carouselShowLimit ? state.selectedProduct.productionAssets.length : carouselShowLimit,
