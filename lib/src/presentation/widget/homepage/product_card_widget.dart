...
class ProductCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var products = context.read<ProductListBloc>().state.productList.products;
    var activeIndex = context.read<ActiveImagesIndexCubit>().state;
                            ...
                            AspectRatio(
                              ...
                              child: ClipRRect(
                                ...
                                child: PageView.builder(
                                    ...
                                    itemBuilder: (ctx, i) {
                                      String urlImage = i == products[index].productionAssets.length
                                        ...
                                        children: [
                                          SizedBox(
                                            ...
                                            child: CachedNetworkImage(
                                                placeholder: (context, url) => Image.asset('assets/homepage/img_default.png', fit: BoxFit.fitWidth),
                                                imageUrl: urlImage,
                                                fit: BoxFit.fitWidth,
