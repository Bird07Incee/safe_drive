      ...
      builder: (context, state) {
        ...
        return BlocBuilder<ActiveImagesIndexCubit, List<int>>(
          builder: (context, activeIndex) {
            ...
            List<Widget> list = [];
            for (int index = 0; index < productList.products!.length; index++) {
              ...
              list.add(RumUserActionAnnotation(
            ...
            return SingleChildScrollView(physics: NeverScrollableScrollPhysics(), child: Column(children: list));
          },
        );
      },
    );
