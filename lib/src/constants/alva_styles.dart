...
class AlvaStyles {
  ...
  TextStyle headingSize14w400(Color color) => TextStyle(
      fontFamily: fontFamily,
      fontSize: 14,
      fontWeight: FontWeight.w400,
      color: color);
  TextStyle headingSize14w500(Color color) => TextStyle(
      fontFamily: fontFamily,
      fontSize: 14,
      fontWeight: FontWeight.w500,
      color: color);
  TextStyle headingSize14w600(Color color) => TextStyle(
      fontFamily: fontFamily,
      fontSize: 14,
  ...
  TextStyle bodySize12W400(Color color) => TextStyle(
      fontFamily: fontFamily,
      fontSize: 12,
      color: color,
      fontWeight: FontWeight.w400);

  TextStyle bodySize12W600(Color color) => TextStyle(
      fontFamily: fontFamily,
      fontSize: 12,
      color: color,
      fontWeight: FontWeight.bold);
